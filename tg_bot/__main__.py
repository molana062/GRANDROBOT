...
PM_START_TEXT = """
**Aloo {}, Aku adalah {}!** 
Aku Adalah Bot Manajemen Group, Bersedia Untuk Membasi Orang-Orang Tolol Di Telegram.
Ketik help untuk melihat beberapa fungsi /help.
...
TECHNO_IMG = "https://telegra.ph/file/ef0b5ae50b5097ea19502.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Betterthaanhecan")],
                                                                                   [InlineKeyboardButton(text="ADD AUZEA TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Channel Owner",
                                                                       url="t.me/ruangpublikk")
                                                                                 ]]))
